...
frame_count = {}
motion_threshold = 30
min_frames_for_bruise = 2

fourcc = cv2.VideoWriter_fourcc(*'mp4v')
out = cv2.VideoWriter('C:/Users/User/Documents/GitHub/construction-safety-vision/videos/resultados/resultado_video4.mp4', fourcc, fps, (int(cap.get(3)), int(cap.get(4))))
